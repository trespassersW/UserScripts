...
//"font: italic bold 14px 'DejaVu Sans';"+ // Quartz
"color: #337; background-color: #CFF;"+
...
function count(ss) {
  var n=new Date(), s=n.getSeconds(), z=':'; //s<30? '\u02D0': ':'; // 
  return dd(n.getHours())+z+dd(n.getMinutes())+
   (ss? ':'+dd(s): "");
}
...
function setClok() {
  ...
  B.CB_plainclock.nClok=B.setInterval(upDate, 250);
  upDate();
}
/* * */
